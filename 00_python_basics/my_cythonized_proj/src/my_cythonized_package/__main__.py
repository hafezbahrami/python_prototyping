...
from my_cythonized_package import __version__


WELCOME_MESSAGE = """
Hello! This is a default command line entry point for my_cythonized_package. When this package is installed, this module
allows you to invoke the cli by running:

    python -m my_cythonized_package
...
def cli() -> int:
    ...
    print(f"my_cythonized_package {__version__}")
